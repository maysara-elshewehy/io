# [←](../uString.md) `uString`.`countWritten`
...
- #### 🧪 Examples
    ...
    ```zig
    _ = string.countWritten(); // 👉 18 (Number of written bytes)
    _ = string.countVisual();  // 👉 8  (Number of Visual characters)
    ```
...
- ##### 🔗 Related
  ...
  > [`uString.countVisual`](./countVisual.md)
